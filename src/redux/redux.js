...
export const fetchCurrencies = () => {
	return (dispatch) => {
		...
		axios
			.get('https://api.nbp.pl/api/exchangerates/tables/a/last/')
			.then(({ data }) => {
...
export const fetchRequested = () => ({ type: FETCH_CURRENCIES_REQUESTED });

export const fetchFailed = () => ({ type: FETCH_CURRENCIES_FAILED });
